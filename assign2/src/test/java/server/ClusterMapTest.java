...
public class ClusterMapTest {
    ...
    @BeforeEach
    void initClusterMap() {
        this.clusterMap1 = new ClusterMap();
        ...
        clusterMap1.add(node1);
        clusterMap1.add(node2);
        clusterMap1.add(node3);
    }

    @BeforeEach
    void initClusterMap2() {
        this.clusterMap2 = new ClusterMap();
        ...
        clusterMap2.add(node1);
        clusterMap2.add(node2);
    }
